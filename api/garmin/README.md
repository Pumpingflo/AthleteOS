...
Kleiner **FastAPI**-Dienst: nimmt Workouts + Garmin-Login entgegen (nur bei authentifizierten Supabase-Nutzern), lädt Einheiten in **Garmin Connect** und kann aktuelle Aktivitäten für den Debrief abrufen.

## Endpoints

- `GET /health`
- `POST /sync` (Plan-Workouts nach Garmin pushen)
- `POST /latest_activity` (letzte Aktivitäten laden, z. B. für Debrief-Autofill)
